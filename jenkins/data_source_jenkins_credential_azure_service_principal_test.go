		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.jenkins_credential_azure_service_principal.foo", "subscription_id", "00000000-0000-0000-0000-000000000001"),
					resource.TestCheckResourceAttr("data.jenkins_credential_azure_service_principal.foo", "client_id", "00000000-0000-0000-0000-000000000002"),
					resource.TestCheckResourceAttr("data.jenkins_credential_azure_service_principal.foo", "tenant", "00000000-0000-0000-0000-000000000003"),
				),
			},
		},
	})
